...
if corr == 'Electricity vs Mean Temperature':
    ...
    plt.legend(bbox_to_anchor=(0.98, 0.1), loc='lower right', borderaxespad=0)
    ax2 = ax1.twinx()
    sns.lineplot(data=df_avg_annual, x='year', y='forest_area', ax=ax2, label='forest_area')
    plt.legend(bbox_to_anchor=(0.98, 0.03), loc='lower right', borderaxespad=0)
    st.pyplot(plt.gcf())
    ...
    plt.legend(bbox_to_anchor=(0.98, 0.1), loc='lower right', borderaxespad=0)
    ax2 = ax1.twinx()
    sns.lineplot(data=df_avg_annual, x='year', y='co2_emission', ax=ax2, label='co2_emission')
    plt.legend(bbox_to_anchor=(0.98, 0.03), loc='lower right', borderaxespad=0)
    st.pyplot(plt.gcf())
    ...
    plt.legend(bbox_to_anchor=(0.98, 0.1), loc='lower right', borderaxespad=0)
    ax2 = ax1.twinx()
    sns.lineplot(data=df_avg_annual, x='year', y='internet', ax=ax2, label='internet')
    plt.legend(bbox_to_anchor=(0.98, 0.03), loc='lower right', borderaxespad=0)
    st.pyplot(plt.gcf())
    ...
    plt.legend(bbox_to_anchor=(0.98, 0.1), loc='lower right', borderaxespad=0)
    ax2 = ax1.twinx()
    sns.lineplot(data=df_avg_annual, x='year', y='population', ax=ax2, label='population')
    plt.legend(bbox_to_anchor=(0.98, 0.03), loc='lower right', borderaxespad=0)
    st.pyplot(plt.gcf())
elif corr == 'Electricity vs Forest Area':
    plt.figure(figsize=(12, 6))
    ax1 = sns.lineplot(data=df_avg_annual, x='year', y='electricity', color='red', label='electricity')
    plt.legend(bbox_to_anchor=(0.98, 0.1), loc='lower right', borderaxespad=0)
    ax2 = ax1.twinx()
    sns.lineplot(data=df_avg_annual, x='year', y='forest_area', ax=ax2, label='forest_area')
    plt.legend(bbox_to_anchor=(0.98, 0.03), loc='lower right', borderaxespad=0)
